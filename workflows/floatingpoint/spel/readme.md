...
* <kbd>⌘</kbd><kbd>↩︎</kbd> Set language then check spelling.
...
You can skip words from the bottom of the list. (Tip: Pressing up arrow will take you to the bottom of the list.)
