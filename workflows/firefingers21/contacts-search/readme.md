...
Configure the Hotkey for faster triggering. For more advanced access, the External Trigger is also available.

Optionally override where contacts are opened with the `URL Handler` field in the Workflow’s Configuration. This can be another app or an External Trigger from another workflow.