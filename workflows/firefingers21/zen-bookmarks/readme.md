...
![Searching for Zen bookmarks](images/keyword.png)
...
![Narrowing search for Zen bookmarks](images/tagFilter.png)
...
Search your Zen history via the `bh` keyword. History entries are searchable by Name and URL.

![Searching Zen history](images/history.png)
