...
![Using the "new" keyword](images/new.png)

Type to filter. Results are searchable by Name, Document Type, and Office Suite.

![Filtering app results by document type](images/newFilter.png)

![Filtering app results by office suite](images/newSuite.png)
...
![Using the "export" keyword on a Pages document](images/export.png)
